...
def test_get_bootstrapped_ROC_CI_curves():
    ...
    (base_fpr,
     ...
     tprs_upper_95,
     az_CI_lower_95,
     az_CI_upper_95) = roc.get_bootstrapped_ROC_CI_curves(Y_pred,
                                                          Y_true,
                                                          num_bootstraps=3,
                                                          CI_to_use=0.95)
    ...
    assert((tprs_lower_95 <= mean_tprs_95).all() and
           (tprs_upper_95 >= mean_tprs_95).all())
    # check that the az values are both in range 0-1
    assert(az_CI_lower_95 >= 0 and az_CI_lower_95 <= 1)
    assert(az_CI_upper_95 >= 0 and az_CI_upper_95 <= 1)
    ...
    (base_fpr,
     ...
     tprs_upper_65,
     az_CI_lower_65,
     az_CI_upper_65) = roc.get_bootstrapped_ROC_CI_curves(Y_pred,
                                                          Y_true,
                                                          num_bootstraps=3,
                                                          CI_to_use=0.65)
...
def test_get_bootstrapped_CI_point_error():
    ...
    (mean_fprs_95,
     ...
     tprs_upper_95,
     fprs_lower_95,
     fprs_upper_95) = roc.get_bootstrapped_CI_point_error(Y_pred,
                                                          Y_true,
                                                          num_bootstraps=100,
                                                          CI_to_use=0.95)
    ...
    assert((fprs_lower_95 <= mean_fprs_95).all() and
           (fprs_upper_95 >= mean_fprs_95).all())
    ...
    (mean_fprs_65,
     ...
     tprs_upper_65,
     fprs_lower_65,
     fprs_upper_65) = roc.get_bootstrapped_CI_point_error(Y_pred,
                                                          Y_true,
                                                          num_bootstraps=100,
                                                          CI_to_use=0.65)
